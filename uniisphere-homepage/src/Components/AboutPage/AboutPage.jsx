...
function AboutPage() {
  ...
  const authLink = "https://main.uniisphere.in/";
  const authLink2 = "https://main.uniisphere.in/signup";
    ...
    >
      ...
      >
        ...
        <motion.p className="our-goal-description" variants={descriptionVariants}>
          Uniisphere is a student networking app designed to connect university students <br /> for academic collaboration, social networking, and career development. It offers <br /> features like secure messaging, event discovery, study groups, mentorship, <br /> freelancing opportunities, and psychological support to create a <br /> comprehensive platform for student engagement and growth.
        </motion.p>
      </motion.div>
